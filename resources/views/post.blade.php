...
<div class="max-w-screen-2xl w-full h-auto mx-auto my-0 mb-20">
    ...
    <div class="py-2 px-4 mb-4 bg-white rounded-lg rounded-t-lg border border-gray-200">
        ...
        <div class="flex items-center">
            @for ($i = 1; $i <= 10; $i++)
                <input type="radio" name="rank" id="rank-{{ $i }}" value="{{ $i }}" class="sr-only" {{ $userRating == $i ? 'checked' : '' }}>
                <label for="rank-{{ $i }}" class="cursor-pointer">
                    <svg class="w-8 h-8 text-gray-400 {{ $userRating >= $i ? 'text-yellow-400' : '' }}" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <section class="py-8 lg:py-16 w-screen">
                <div class="mx-auto">
                    ...
                    <div class="py-2 px-4 mb-4 bg-white rounded-lg rounded-t-lg border border-gray-200">
                        ...
                        <div class="flex items-center">
                            @for ($i = 1; $i <= 10; $i++)
                                <svg class="w-8 h-8 text-gray-400 {{ $averageRating >= $i ? 'text-yellow-400' : '' }}" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                                </svg>
                            @endfor
                        </div>
